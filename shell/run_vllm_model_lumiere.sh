#!/usr/bin/env bash
# LUMIERE variant of run_vllm_model.sh (runs run_lumiere.py; pass --include-unreviewed for preliminary runs).
...
#
# Uses run_lumiere.py's own --n-cases default (100) unless overridden below — in
